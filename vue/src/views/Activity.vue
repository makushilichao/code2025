    ...
    <div>
        ...
        <div class="card" style="margin-bottom: 5px">
            ...
            >
                ...
                <el-table-column prop="adminName" label="发布用户"/>
        ...
        <el-dialog title="活动信息" v-model="data.formVisible" width="60%" destroy-on-close="true">
            <el-form ref="formRef" :model="data.form">
                ...
                <el-form-item label="活动标题" prop="title">
                    <el-input v-model="data.form.title" autocomplete="off" placeholder="请输入活动标题"
        ...
        <el-dialog title="活动内容" v-model="data.viewVisible" width="60%" destroy-on-close>
            <!-- 修改此处，添加样式 -->
